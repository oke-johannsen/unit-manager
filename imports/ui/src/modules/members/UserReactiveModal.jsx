...
const UserReactivateModal = ({ openUserReactivateModal, setOpenUserReactivateModal }) => {
  ...
  return (
    ...
    >
      <Row>
        <Col>
          Bist du sicher, dass du {openUserReactivateModal && openUserReactivateModal.length}{' '}
          {openUserReactivateModal.length === 1 ? 'Mitglied' : 'Mitglieder'} auf aktiv setzen möchtest?
        </Col>
